...
" "
const socialLinks = [
  { icon: Github, href: "https://github.com/V-Sopanha", label: "ហ្គីតហាប" },
  { icon: Linkedin, href: "https://linkedin.com", label: "លីងអ៊ីន" },
  { icon: Mail, href: "mailto:Sopanha2310@gmail.com", label: "អ៊ីមែល" }
];
